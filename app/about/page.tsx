      ...
      <section className="section tint-blue">
        <div className="container">
          <div style={{ maxWidth: 720, margin: '0 auto' }}>
            ...
            <img className="about-photo" src="/about-team.png" alt="The team behind Squeegeez" style={{ marginBottom: 36 }} />

            <h3>The People Behind Squeegeez</h3>
            <p>
            ...
            <h3 style={{ marginTop: 32 }}>Our Mission</h3>
            <p>
            ...
            <h3 style={{ marginTop: 32 }}>Local by Choice</h3>
